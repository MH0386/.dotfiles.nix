...
on:
  workflow_run:
    workflows: ["Agentic Maintenance", "AGENTS.md Maintainer", "Code Simplifier", "GitHub Agentic Workflows Compile", "Nix Doctor"]
    types:
      - completed
    branches:
      - main
...
source: githubnext/agentics/workflows/ci-doctor.md@dcdf09723d42ef9b6c75335e4612fd145d4ccdaa
---
